export default function AlertaDisplay({ alerta, onClose, variant = 'success' }) {
  ...
  return (
    <div style={{ position: 'relative', background: bg, border: `1px solid ${border}`, color: '#000', padding: 12, borderRadius: 6 }}>
      <button onClick={onClose} aria-label="Cerrar" style={{ position: 'absolute', top: 6, right: 8, background: 'transparent', border: 'none', fontSize: 16, cursor: 'pointer' }}>✕</button>
